...
contract GoldilocksPoseidonOpt {
    ...
    bytes constant FAST_PARTIAL_FIRST_ROUND_CONSTANTS =
        "";
    // uint256[12] FAST_PARTIAL_FIRST_ROUND_CONSTANTS = [
    ...
    // bytes FAST_PARTIAL_ROUND_CONSTANTS =
    //     "";
    ...
    uint256[11][N_PARTIAL_ROUNDS] FAST_PARTIAL_ROUND_VS = [
        [
            0x94877900674181c3,
            0xc6c67cc37a2a2bbd,
            0xd667c2055387940f,
    ...
    uint256[11][N_PARTIAL_ROUNDS] FAST_PARTIAL_ROUND_W_HATS = [
        [
            0x3d999c961b7c63b0,
            0x814e82efcd172529,
            0x2421e5d236704588,
    ...
    uint256[11][11] FAST_PARTIAL_ROUND_INITIAL_MATRIX = [
        [
            0x80772dc2645b280b,
            0xdc927721da922cf8,
            0xc1978156516879ad,
    ...
    function _mds_partial_layer_fast(
        ...
        unchecked {
            ...
            for (uint256 i = 1; i < 12; i++) {
                new_state[i] = add(
                    state[i],
                    state[0] * FAST_PARTIAL_ROUND_VS[r][i - 1]
                );
            }
        }
    }
    ...
    function _partial_first_constant_layer(
        ...
        bytes memory c = FAST_PARTIAL_FIRST_ROUND_CONSTANTS;
        for (uint256 i = 0; i < 12; i++) {
            // uint256 state_i = state[i];
            // assembly {
            //     state_i := addmod(
            //         state_i,
            //         mload(add(c, add(0x00, mul(i, 0x20)))),
            //         ORDER
            //     )
            // }

            uint256 round_constant;
            assembly {
                round_constant := mload(add(c, add(0x00, mul(i, 0x20))))
            }

            console.logUint(round_constant);
            new_state[i] = add(state[i], round_constant);

            // new_state[i] = state_i;
            // new_state[i] = add(state[i], FAST_PARTIAL_FIRST_ROUND_CONSTANTS[i]);
        }
